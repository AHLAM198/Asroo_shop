...
import 'package:asroo_uod/services/product_services.dart';
...
// onInt ->  عشان نستدعي
  ...
  // Logic Favourites Screen

  void manageFavourites(int productId) async {
    var existingIndex =
        favouritesList.indexWhere((element) => element.id == productId);

    // remove احذف حاجه معينه مثلا اذا بحذف اسم احلام  حلها اني استخدم removeat
    // removeAt -> تحتاج الى index
